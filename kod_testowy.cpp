...
int opoznienieZamknieciaChwytaka = 3;
const int zeroM1 = 500; //500 - 2380
const int zeroM2 = 75;
const int zeroM3 = 30;
const int zeroM4 = 170;
const int zeroM5 = 90;
...
int celM4 = zeroM4;
int celM5 = zeroM5;
static unsigned long czasM1 = 0;
static unsigned long czasM2 = 0;
static unsigned long czasM3 = 0;
static unsigned long czasM4 = 0;
static unsigned long czasM5 = 0;
...
void RuchServaM1(int nowyCzas) {
  if (nowyCzas < 0) nowyCzas = 0;
  if (nowyCzas > 2380) nowyCzas = 2380;
  if (millis() - czasM1 >= opoznienieZamknieciaChwytaka) {
    if (ostatniCzasM1 < nowyCzas) {
      ostatniCzasM1++;
      servoM1.writeMicroseconds(ostatniCzasM1);
    }
    else if (ostatniCzasM1 > nowyCzas) {
      ostatniCzasM1--;
      servoM1.writeMicroseconds(ostatniCzasM1);
    }
    Serial.print("Servo M1 przesuniete na nowy czas: ");
    Serial.println(ostatniCzasM1);
    czasM1 = millis();
  }
}
...
void RuchServaM2(int nowyKat) {
  if (nowyKat < 0) nowyKat = 0;
  if (nowyKat > 150) nowyKat = 150;
  if (millis() - czasM2 >= opoznienieRuchuSerwa) {
    if (ostatniKatM2 < nowyKat) {
      ostatniKatM2++;
      servoM2.write(ostatniKatM2);
    }
    else if (ostatniKatM2 > nowyKat) {
      ostatniKatM2--;
      servoM2.write(ostatniKatM2);
    }
    Serial.print("Servo M2 przesuniete na nowy kat: ");
    Serial.println(ostatniKatM2);
    czasM2 = millis();
  }
}
...
void RuchServaM3(int nowyKat) {
  if (nowyKat < 0) nowyKat = 0;
  if (nowyKat > 180) nowyKat = 180;
  if (millis() - czasM3 >= opoznienieRuchuSerwa) {
    if (ostatniKatM3 < nowyKat) {
      ostatniKatM3++;
      servoM3.write(ostatniKatM3);
    }
    else if (ostatniKatM3 > nowyKat) {
      ostatniKatM3--;
      servoM3.write(ostatniKatM3);
    }
    Serial.print("Servo M3 przesuniete na nowy kat: ");
    Serial.println(ostatniKatM3);
    czasM3 = millis();
  }
}
...
void RuchServaM4(int nowyKat) {
  if (nowyKat < 0) nowyKat = 0;
  if (nowyKat > 180) nowyKat = 180;
  if (millis() - czasM4 >= opoznienieRuchuSerwa) {
    if (ostatniKatM4 < nowyKat) {
      ostatniKatM4++;
      servoM4.write(ostatniKatM4);
    }
    else if (ostatniKatM4 > nowyKat) {
      ostatniKatM4--;
      servoM4.write(ostatniKatM4);
    }
    Serial.print("Servo M4 przesuniete na nowy kat: ");
    Serial.println(ostatniKatM4);
    czasM4 = millis();
  }
}
...
void RuchServaM5(int nowyKat) {
  if (nowyKat < 0) nowyKat = 0;
  if (nowyKat > 180) nowyKat = 180;
  if (millis() - czasM5 >= opoznienieRuchuSerwa) {
    if (ostatniKatM5 < nowyKat) {
      ostatniKatM5++;
      servoM5.write(ostatniKatM5);
    }
    else if (ostatniKatM5 > nowyKat) {
      ostatniKatM5--;
      servoM5.write(ostatniKatM5);
    }
    Serial.print("Servo M5 przesuniete na nowy kat: ");
    Serial.println(ostatniKatM5);
    czasM5 = millis();
  }
}
...
//
// Created by jan97 on 25.12.2025.
//
